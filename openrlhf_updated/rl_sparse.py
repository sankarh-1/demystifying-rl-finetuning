...
def train_rl_sparse():
    print("=== [PHASE 4] RL Training: Sparse Reward ===")
    ...
    rl_sparse_final = str(config.MODELS_DIR / "rl_sparse" / "final")
    ...
    cmd = [
        ...
        "--wandb_run_name", "rl_sparse_training",
